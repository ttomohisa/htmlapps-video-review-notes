...
echo Checking PowerShell syntax and encoding...
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\check-powershell-syntax.ps1"
if errorlevel 1 (
  echo.
  echo PowerShell preflight failed. Review the message above.
  pause
  exit /b 1
)
